...
public class ScreenShare extends BaseFragment implements View.OnClickListener {
    ...
    private Button join, start, stop;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_join)
        {
            ...
            startScreenShare();
            showLongToast(String.format("Starting screen share"));

        }else if (v.getId() == R.id.btn_stop){
            stopScreenShare();
            showLongToast(String.format("Stopping screen share"));
    ...
    private void stopScreenShare(){
        ...
        description.setText("Screen Sharing Stopping");
    }
